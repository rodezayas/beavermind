...
- [x] T5 — Implement `guardrail_node` (empty / <4 turns / oversized → failed; sanitizes and flags). Covers: R5, R7, R10–R12.
- [x] T6 — Implement `make_score_node(call_type, scoring_fn)` with error boundary. Covers: R6, R7, R8.
